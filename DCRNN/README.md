# Next Steps:
Please copy the content of data: https://drive.google.com/drive/folders/1UyHK-cb-edt9qFy9HTMVSYjJrORzwV4r?usp=sharing
into this environment's data folder.

Create a new environment (can use conda or pyCharms envs), and install the updated requirements into that environment:

`pip install -r requirements.txt`

or

`conta install --file requirements.txt`

#### Then you can jump to 'Model Training' with the following command
